...
extension AsyncThrowingFunction where Self: Sendable {
	...
	public func pipe<A: AsyncThrowingFunction & Sendable>(
		_ a: A
	) -> SendableAsyncThrowingFunc<Input, A.Output, Either<Failure, A.Failure>>
	where A.Input == Output {
	...
	public func pipe<A: AsyncThrowingFunction & Sendable>(
		_ a: A
	) -> SendableAsyncThrowingFunc<Input, A.Output, A.Failure>
	where A.Input == Output, Failure == A.Failure {
	...
	public func pipe<A: _MainActorAsyncThrowingFunction & Sendable>(
		_ a: A
	) -> MainActorAsyncThrowingFunc<Input, A.Output, Either<Failure, A.Failure>>
	where A.Input == Output, Input: Sendable {
	...
	public func pipe<A: _MainActorAsyncThrowingFunction & Sendable>(
		_ a: A
	) -> MainActorAsyncThrowingFunc<Input, A.Output, A.Failure>
	where A.Input == Output, Failure == A.Failure, Input: Sendable {
...
extension AsyncFunction where Self: Sendable {
	...
	public func pipe<A: AsyncFunction & Sendable>(
		_ a: A
	) -> SendableAsyncFunc<Input, A.Output>
	where A.Input == Output {
...
extension SyncThrowingFunction where Self: Sendable {
	...
	public func pipe<A: SyncThrowingFunction & Sendable>(
		_ a: A
	) -> SendableSyncThrowingFunc<Input, A.Output, Either<Failure, A.Failure>>
	where A.Input == Output {
	...
	public func pipe<A: SyncThrowingFunction & Sendable>(
		_ a: A
	) -> SendableSyncThrowingFunc<Input, A.Output, A.Failure>
	where A.Input == Output, Failure == A.Failure {
	...
	public func pipe<A: _MainActorSyncThrowingFunction & Sendable>(
		_ a: A
	) -> MainActorSyncThrowingFunc<Input, A.Output, Either<Failure, A.Failure>>
	where A.Input == Output, Input: Sendable {
	...
	public func pipe<A: _MainActorSyncThrowingFunction & Sendable>(
		_ a: A
	) -> MainActorSyncThrowingFunc<Input, A.Output, A.Failure>
	where A.Input == Output, Failure == A.Failure, Input: Sendable {
...
extension SyncFunction where Self: Sendable {
	...
	public func pipe<A: SyncFunction & Sendable>(
		_ a: A
	) -> SendableSyncFunc<Input, A.Output>
	where A.Input == Output {
